...
export default function Home() {
    ...
    let minMonthlySalary = 10000;
    let maxMonthlySalary = 10000000;
    let stepMonthlySalary = 100000;
    let minYears = 5;
    let maxYears = 50;
    ...
    return (
        <div className={"app—bg—container overflow—hidden"}>
            {/* <PageSEO title={'Gratuity Calculator - Calculate Gratuity Online - FundsIndia'}
            description={"Know your gratuity amount on retirement with FundsIndia's Online Gratuity Calculator and plan your investments"} /> */}
                ...
                <CalculatorAndSidePannel>
                    ...
                    <CalculatorWrapper>
                        ...
                        <div className={"lg:w-[50%] text-center self-center leading-9"}>
                            <div className={"font-bold text-4xl "}><span className="font-['Rubik']">{'\u20B9 '}</span>{output}</div>
                            <div className="font-semibold">Payable Gratuity</div>
                        </div>
                    </CalculatorWrapper>

                    {/* Side Pannel */}
                    <div className="xl:max-h-[289.2px] [@media(min-width:1920px)]:max-h-[303.2px] xl:w-[23%] ">
                        <InfoBox
                            type="sidePannel"
                            contents={[
                                [
