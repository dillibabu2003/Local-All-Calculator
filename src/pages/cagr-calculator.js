...
export default function Home() {
    ...
    const stepInitialAmount = 100000;

    const minFinalAmount = 1000;
    const maxFinalAmount = 500000000;
    const stepFinalAmount = 100000;
    ...
    const [corpusPoints, setCorpusPoints] = useState([
        100000, 125893, 158489, 199526, 251189,
        316228, 398107, 501187,
        630957, 794328, 1000000,
    ]);

    const [initialInvestmentPoints, setInitialInvestmentPoints] = useState([
    ...
    function calculateGraphPoints() {
        ...
        for (let i = 0; i <= years; i++) {
            points1.push(cumulativeAmount);
            points2.push(initialAmount);
    ...
    return (
        <div className={"app—bg—container overflow—hidden "}>
            {/* <PageSEO title={'CAGR Calculator - calculate the compounded annual growth rate - FundsIndia'}
                    ...
                    <CalculatorWrapper>
                        ...
                        <div className={"lg:w-[50%]"}>
                            ...
                            <div className={" relative object-right-top"}>
                                {isLineChart ? (
                                    <>
                                        <LineChart points={optionsForLine} />
                                        {/* <LineChart points={newGraphPoints} /> */}
                                        <div
                                            className={
