...
export default function Home() {
    ...
    let stepTotalInvestment = 1000000;
    ...
    const [corpusPoints, setCorpusPoints] = useState([100000, 105000, 110000, 115000, 120000, 125000]);

    const [initialInvestmentPoints, setInitialInvestmentPoints] = useState([100000, 100000, 100000, 100000, 100000, 100000]);
    ...
    function calculate() {
        if (minTotalInvestment <= totalInvestment &&
            ...
            calculatecorpusPoints();
        }
    }


    function calculatecorpusPoints() {
        let points1 = [], points2 = [];
        points1.push(totalInvestment);
        points2.push(totalInvestment);
        for (let i = 1; i <= timePeriod; i++) {

            points1.push(totalInvestment + Math.ceil(totalInvestment * interestRate * i) / 100);
            points2.push(totalInvestment);
        }
        setCorpusPoints(points1);
        setInitialInvestmentPoints(points2);
    }
                    ...
                    <div className="xl:max-h-[369.2px] [@media(min-width:1920px)]:max-h-[385.2px]  xl:w-[23%] ">
                        <InfoBox
                            ...
                            contents={[
                                [
                                    "Simple Interest",
                                    "Simple interest is a method of calculating the interest on a loan or deposit. It is calculated as the product of the principal amount, interest rate, and time period divided by 100",
                                ],
                                [
                                ...
                                [
                                    ...
                                    <>
                                        ...
                                        <br />
                                        <b>
                                            I = (P*N*R)/100<br /> Where: <br />P = Principal (the initial amount) <br />T = Time Period (in years)<br /> R = Interest Rate (as a decimal)
                                        </b>
                                    </>,
                                ],
                            ]}
