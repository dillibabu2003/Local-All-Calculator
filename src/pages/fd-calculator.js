...
export default function Home() {
    ...
    const stepTotalInvestment = 1000000;
    ...
    const [maturityGraphPoints, setMaturityGraphPoints] = useState([
        100000, 107000, 114490, 122504, 131080, 140255, 150073, 160578, 171819, 183846, 196715
    ]);
    const [investmentGraphPoints, setInvestmentGraphPoints] = useState([
    ...
    function calculateGraphPoints() {
        ...
        let cumulativeAmount = (totalInvestment);
        for (let i = 1; i <= timePeriod; i++) {
            investmentPoints.push(totalInvestment);
            maturityPoints.push(cumulativeAmount); //[100000, 107000, 114490]
            cumulativeAmount += Number((cumulativeAmount * interestRate) / 100);
        }
        investmentPoints.push(totalInvestment);
        maturityPoints.push(cumulativeAmount);
